...
| `QWEN36_LM_HEAD_FP8` | **off** (WIP 2026-06-11) | `=1` quantizes lm_head to e4m3 per-row at init and DROPS the BF16 original (−1.18 GiB; probe 0/28 argmax flips). N=1 GEMV at 90% peak (790 µs vs cuBLAS 1.65 ms), MTP=0 +2%, floor 10/10, chat acceptance unchanged; default off until the N>1 batched call beats cuBLAS and the raw-corpus short-ctx acceptance coupling (−0.12 @128) is arbitrated |
